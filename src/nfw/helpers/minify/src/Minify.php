...
abstract class Minify
{
     ...
     *
     * @param CacheInterface $item Cache item to write the data to.
     *
     * @return CacheInterface Cache item with the minifier data.
     */
    public function cache(CacheInterface $item)
    {
